    ...
    return (
        <div className='fixed bg-black bg-opacity-60 top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center' onClick={onClose}>
            <div className='w-[600px] max-w-full h-[400px] bg-white rounded-xl p-4 flex flex-col relative' onClick={(event) => event.stopPropagation()}>
                ...
                <h2 className='w-fit px-4 py-1 bg-red-300 rounded-lg'>{book.rating}</h2>
                ...
                <p className='my-2'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolore aliquid porro atque voluptatibus sit eius laborum expedita voluptates, earum explicabo nobis ex unde velit? Voluptates consequatur ipsa tenetur magnam repudiandae?</p>
            </div>
        </div>
    )
}
